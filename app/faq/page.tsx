  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: '메이플 디스코드는 어떤곳인가요?',
          a: '메이플스토리 게임을하는 유저들이 모여 있는곳입니다.'
        },
        {
          q: '디스코드에서 무엇을 하는건가요?',
          a: '소통, 거래, 사냥, 파티, 보스, 길드 다양한 것을 할 수 있습니다.'
        },
        {
          q: '인증을 받으라는데 어떻게 받아야 하나요?',
          a: '인증안내 페이지를 참고 하시면 잘 설명 되어 있습니다.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          q: '시세는 어떻게 결정되나요?',
          a: '메이플스토리 게임 내 경제 상황과 시장 수급에 따라 실시간으로 변동됩니다.'
        },
        {
          q: '대량 거래도 가능한가요?',
        ...
        <div style={{ marginTop: '80px', paddingTop: '60px', borderTop: '3px solid #E2E8F0' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              {[
                ...
                },
                {
                  number: '2',
                  title: '선입금 요구 주의',
                  desc: '거래 전 선입금을 요구하는 경우 반드시 의심하세요. 정상적인 거래는 아이템 확인 후 결제가 이루어집니다.'
                },
                {
                  number: '3',
                  title: '시세 확인',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {[
                { type: '선입금 사기', desc: '아이템을 보여주지 않고 먼저 입금을 요구합니다.' },
