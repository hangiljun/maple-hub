  ...
  const faqs = [
    ...
    },
    {
      ...
      questions: [
        {
          q: '거래가 안전한가요?',
          a: '메이플 허브는 정식 사업자등록을 완료한 중개 플랫폼입니다. 당사는 신뢰할 수 있는 판매자만 선별하여 연결해드리며, 거래 관련 문의사항은 언제든 상담 가능합니다.'
        },
        {
          q: '거래 중개는 어떻게 이루어지나요?',
        ...
        {
          q: '문제가 생기면 어떻게 하나요?',
          a: '거래 과정에서 문제가 발생하면 즉시 카카오톡으로 신고해주세요. 거래 증빙 자료를 보관하고 계시면 빠른 해결이 가능합니다.'
        }
      ]
    },
    {
